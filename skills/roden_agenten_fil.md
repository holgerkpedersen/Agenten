---
name: roden_agenten_fil
keywords: [roden, agenten, fil, indholdet, hello, projektet, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **roden, agenten, indholdet, hello, projektet**.
