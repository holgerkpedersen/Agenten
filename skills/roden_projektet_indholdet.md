---
name: roden_projektet_indholdet
keywords: [roden, projektet, indholdet, hello, agenten, fil, holger, hej]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **roden, projektet, indholdet, hello, agenten**.
