---
name: projektet_agenten_hello
keywords: [projektet, agenten, hello, indholdet, fil, roden, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **projektet, agenten, hello, indholdet, roden**.
