---
name: fil_indholdet_hello
keywords: [fil, indholdet, hello, roden, projektet, agenten, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **indholdet, hello, roden, projektet, agenten**.
