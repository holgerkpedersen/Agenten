---
name: agenten_hello_projektet
keywords: [agenten, hello, projektet, fil, roden, indholdet, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **agenten, hello, projektet, roden, indholdet**.
