---
name: agenten_projektet_hello
keywords: [agenten, projektet, hello, indholdet, fil, roden, holger, hej]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **agenten, projektet, hello, indholdet, roden**.
