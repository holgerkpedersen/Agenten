---
name: roden_hello_projektet
keywords: [roden, hello, projektet, indholdet, fil, agenten, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **roden, hello, projektet, indholdet, agenten**.
