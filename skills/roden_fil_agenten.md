---
name: roden_fil_agenten
keywords: [roden, fil, agenten, projektet, hello, indholdet, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **roden, agenten, projektet, hello, indholdet**.
