---
name: agenten_fil_hello
keywords: [agenten, fil, hello, roden, indholdet, projektet, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **agenten, hello, roden, indholdet, projektet**.
