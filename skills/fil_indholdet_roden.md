---
name: fil_indholdet_roden
keywords: [fil, indholdet, roden, projektet, hello, agenten, holger, opret]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **indholdet, roden, projektet, hello, agenten**.
