...
keywords: [projektet, indholdet, agenten, fil, roden, hello, holger, hej]
...
1. **Analyze the request**: Identify the specific files, components, or areas involved. Tasks in this category typically relate to: **projektet, indholdet, agenten, roden, hello**.
