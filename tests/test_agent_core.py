...
class TestAgentInit:
    ...
    def test_template_tools_mapping(self):
        assert agent_skills.TEMPLATE_TOOLS["resume"] == ["list_chunks", "read_chunk"]
        assert agent_skills.TEMPLATE_TOOLS["kodeanalyse"] == ["list_chunks", "read_chunk"]
        assert agent_skills.TEMPLATE_TOOLS["diffanalyse"] == ["list_chunks", "read_chunk", "git_diff", "git_log"]
        assert agent_skills.TEMPLATE_TOOLS["fri"] is None
        assert agent_skills.TEMPLATE_TOOLS["programmering"] == ["list_chunks", "read_chunk", "write_file", "add_image"]
        assert agent_skills.TEMPLATE_TOOLS["python-arkitektur"] == ["list_chunks", "read_chunk", "write_file"]
        assert agent_skills.TEMPLATE_TOOLS["billedanalyse"] == ["add_image", "write_file", "list_chunks", "read_chunk"]
        assert agent_skills.TEMPLATE_TOOLS["bugfix"] == ["read_issue", "update_issue_status", "run_tests", "create_refactor_issue", "list_chunks", "read_chunk", "write_file"]
