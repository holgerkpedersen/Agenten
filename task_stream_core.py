...
from tool_call_extractor import _extract_tool_call_content
from autoresearch_executor import _execute_autoresearch_issue
import json
import time
import agent_git
    ...
    for i in range(max_iterations):
        ...
        if pending_tc:
            ...
            for tc in pending_tc:
                ...
                # run_tests: track in called_tools for phase checks, skip dedup blocking
