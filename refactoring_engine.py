...
from ast_analyzer import ImportVisitor, SymbolNode, DependencyGraph, AstAnalyzer, ImportResolver
...
class RefactoringEngine:
    ...
    def run_extraction_plan(
        ...
        # Parse modules from plan via shared plan_parser
        plan_dict = parse_refactor_plan(plan_content)
        ...
        all_planned_modules = set(parse_modules_from_plan(plan_content))
