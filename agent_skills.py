...
SECTION_INSTRUCTIONS = {
    ...
    "kodeanalyse": {
        "Form\u00e5l": "L\u00e6s f\u00f8rst docs/formaal.md hvis den findes (read_chunk) \u2014 overskriv IKKE eksisterende analyser uden at l\u00e6se dem. Send FLERE read_location-kald p\u00e5 \u00e9n gang for at gennemg\u00e5 funktionerne hurtigt. Brug derefter write_file(path='docs/formaal.md', content='...', overwrite=true) til at gemme analysen. Forklar hvad filen g\u00f8r og dens rolle i projektet. Vurder filens cohesion og om den overholder single responsibility.",
        "Imports og afh\u00e6ngigheder": "L\u00e6s f\u00f8rst docs/imports.md hvis den findes (read_chunk) \u2014 overskriv IKKE eksisterende analyser uden at l\u00e6se dem. Send FLERE read_location-kald p\u00e5 \u00e9n gang for at gennemg\u00e5 funktionernes imports. Brug derefter write_file(path='docs/imports.md', content='...', overwrite=true) til at gemme analysen. Gennemg\u00e5 filens imports og eksterne afh\u00e6ngigheder. Bem\u00e6rk ubrugte imports, cirkul\u00e6re afh\u00e6ngigheder og versionsproblemer.",
        "Arkitektur": "L\u00e6s f\u00f8rst docs/arkitektur.md hvis den findes (read_chunk) \u2014 overskriv IKKE eksisterende analyser uden at l\u00e6se dem. Send FLERE read_location-kald p\u00e5 \u00e9n gang for at gennemg\u00e5 strukturen hurtigt. Brug derefter write_file(path='docs/arkitektur.md', content='...', overwrite=true) til at gemme analysen. Analys\u00e9r filens struktur, klasser og funktioner. Vurder anvendte design patterns, kobling (coupling) mellem moduler, cohesion, og om SOLID-principperne overholdes.",
        "Kodekvalitet": "L\u00e6s f\u00f8rst docs/kodekvalitet.md hvis den findes (read_chunk) \u2014 overskriv IKKE eksisterende analyser uden at l\u00e6se dem. Send FLERE read_location-kald p\u00e5 \u00e9n gang for at gennemg\u00e5 funktionerne hurtigt. Brug derefter write_file(path='docs/kodekvalitet.md', content='...', overwrite=true) til at gemme analysen. Vurder l\u00e6sbarhed, vedligeholdbarhed, test coverage, navngivning (PEP 8), type hints, fejlh\u00e5ndtering, complexity, DRY-princippet og separation of concerns.",
        "Sikkerhed": "L\u00e6s f\u00f8rst docs/sikkerhed.md hvis den findes (read_chunk) \u2014 overskriv IKKE eksisterende analyser uden at l\u00e6se dem. Send FLERE read_location-kald p\u00e5 \u00e9n gang for at gennemg\u00e5 funktionerne hurtigt. Brug derefter write_file(path='docs/sikkerhed.md', content='...', overwrite=true) til at gemme analysen. Analys\u00e9r inputvalidering (XSS, SQL injection), autentifikation og session management, access control/autorisation, kryptering og databeskyttelse, fejlh\u00e5ndtering, s\u00e5rbarheder i dependencies, security headers. F\u00f8lg OWASP top 10.",
    },
    "diffanalyse": {
