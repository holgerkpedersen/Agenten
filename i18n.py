...
class K(StrEnum):
    ...
    TF_SELVFORBEDRING   = "template_fallback.selvforbedring"
    ...
    TOOL_READ_LOCATION                  = "tools.read_location"
    TOOL_READ_CHUNK                     = "tools.read_chunk"
    TOOL_LIST_CHUNKS                    = "tools.list_chunks"
    TOOL_LIST_SYMBOLS                   = "tools.list_symbols"
    TOOL_LOCATE                         = "tools.locate"
    ...
    LOG_EXTRACT_INCOMPLETE      = "log.extract_incomplete"
    ...
    LOG_RED_TEST_PASSED_GUIDANCE = "log.red_test_passed_guidance"
    ...
    UI_REUSE_NO_SESSION    = "ui.reuse_no_session"
    UI_REUSE_FETCHING      = "ui.reuse_fetching"
    UI_REUSE_LOAD_FAILED   = "ui.reuse_load_failed"
    UI_REUSE_HTTP_ERROR    = "ui.reuse_http_error"
    UI_REUSE_DONE          = "ui.reuse_done"
    UI_REUSE_TOAST         = "ui.reuse_toast"
    UI_REUSE_ERROR         = "ui.reuse_error"
    UI_SELECT_SESSION_FIRST = "ui.select_session_first"
    ...
    # === Phase check descriptions (i18n) ===
    PHASE_CHECK_FILE_EXISTS_SINGLE  = "phase_check.file_exists_single"
    PHASE_CHECK_FILE_EXISTS_ALL     = "phase_check.file_exists_all"
    PHASE_CHECK_FILE_EXISTS_ANY     = "phase_check.file_exists_any"
    PHASE_CHECK_FILES_FROM_PLAN     = "phase_check.files_from_plan"
    PHASE_CHECK_FILES_FROM_PLAN_MIN = "phase_check.files_from_plan_min"
    PHASE_CHECK_ALL_OF              = "phase_check.all_of"
    PHASE_CHECK_TOOL_CALLED         = "phase_check.tool_called"
    PHASE_CHECK_TOOL_CALLED_ALL     = "phase_check.tool_called_all"
    PHASE_CHECK_TESTS_PASS          = "phase_check.tests_pass"
    PHASE_CHECK_CODE_CONTAINS       = "phase_check.code_contains"
    PHASE_CHECK_CODE_CONTAINS_ALL   = "phase_check.code_contains_all"
    PHASE_CHECK_CODE_CONTAINS_MIN   = "phase_check.code_contains_min"
    PHASE_CHECK_MIN_TEXT_LENGTH     = "phase_check.min_text_length"
    PHASE_CHECK_SYMBOLS_COVERED     = "phase_check.symbols_covered"

    # Template+phase specific descriptions
    PHASE_CHECK_REFACTOR_ANALYSE    = "phase_check.refactor.analyse"
    PHASE_CHECK_REFACTOR_PLAN       = "phase_check.refactor.plan"
    PHASE_CHECK_REFACTOR_EKSTRAHER  = "phase_check.refactor.ekstraher"
    PHASE_CHECK_REFACTOR_OPDATER    = "phase_check.refactor.opdater"
    PHASE_CHECK_REFACTOR_TEST       = "phase_check.refactor.test"
    PHASE_CHECK_BUGFIX_ANALYSE      = "phase_check.bugfix.analyse"
    PHASE_CHECK_BUGFIX_TEST_RED     = "phase_check.bugfix.test_red"
    PHASE_CHECK_BUGFIX_IMPLEMENTERING = "phase_check.bugfix.implementering"
    PHASE_CHECK_BUGFIX_VERIFIKATION = "phase_check.bugfix.verifikation"
    PHASE_CHECK_BUGFIX_OPDATERING   = "phase_check.bugfix.opdatering"
    PHASE_CHECK_ISSUE_LAES          = "phase_check.issue_handler.laes"
    PHASE_CHECK_ISSUE_AFKLAR        = "phase_check.issue_handler.afklar"
    PHASE_CHECK_ISSUE_FIX           = "phase_check.issue_handler.fix"
    PHASE_CHECK_ISSUE_LUK           = "phase_check.issue_handler.luk"
    PHASE_CHECK_TESTGEN_ANALYSE     = "phase_check.testgenerering.analyse"
    PHASE_CHECK_TESTGEN_TEST_RED    = "phase_check.testgenerering.test_red"
    PHASE_CHECK_TESTGEN_IMPLEMENTERING = "phase_check.testgenerering.implementering"
    PHASE_CHECK_TESTGEN_VERIFIKATION = "phase_check.testgenerering.verifikation"
    PHASE_CHECK_KODEANALYSE_FORMAAL = "phase_check.kodeanalyse.formaal"
    PHASE_CHECK_KODEANALYSE_IMPORTS = "phase_check.kodeanalyse.imports"
    PHASE_CHECK_KODEANALYSE_ARKITEKTUR = "phase_check.kodeanalyse.arkitektur"
    PHASE_CHECK_KODEANALYSE_KVALITET = "phase_check.kodeanalyse.kvalitet"
    PHASE_CHECK_KODEANALYSE_SIKKERHED = "phase_check.kodeanalyse.sikkerhed"
    PHASE_CHECK_PROG_KRAVANALYSE    = "phase_check.programmering.kravanalyse"
    PHASE_CHECK_PROG_ARKITEKTUR     = "phase_check.programmering.arkitekturdesign"
    PHASE_CHECK_PROG_IMPL_PLAN      = "phase_check.programmering.implementeringsplan"
    PHASE_CHECK_PROG_SIKKERHED      = "phase_check.programmering.sikkerhedsanalyse"
    PHASE_CHECK_PROG_UDDYB          = "phase_check.programmering.uddyb"
    PHASE_CHECK_PROG_KODEIMPLEMENTERING = "phase_check.programmering.kodeimplementering"
    PHASE_CHECK_SELV_ANALYSER       = "phase_check.selvforbedring.analyser"
    PHASE_CHECK_SELV_DIAGNOSTICER   = "phase_check.selvforbedring.diagnosticer"
    PHASE_CHECK_SELV_RET            = "phase_check.selvforbedring.ret"
    PHASE_CHECK_SELV_VERIFICER      = "phase_check.selvforbedring.verificer"
    PHASE_CHECK_SELV_COMMIT         = "phase_check.selvforbedring.commit"
